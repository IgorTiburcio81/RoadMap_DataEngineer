...
Existem muitas ferramentas de ingestão no mercado, algumas nativas de plataformas de nuvem e outras não. Para iniciar, uma boa opção é a biblioteca Python **dlt**, onde você pode ir construindo sua ingestão de dados de maneira estruturada e simples, sendo ideal para quem busca flexibilidade total através do código. Outra opção é o **Airbyte**, que contempla uma versão gratuita que você pode hospedar e executar na sua própria máquina, porém é necessário o Docker para executá-lo. O Airbyte se destaca pela velocidade, já que possui centenas de conectores prontos para diversas ferramentas de mercado, o que facilita muito o trabalho de extração. Essas ferramentas organizam sua ingestão de dados, como os esquemas (schemas) de dados, o que evita quebras de pipelines e facilita a manutenção.

### 📚 Onde aprender de graça?

- [IBM — O que é ingestão de dados?](https://www.ibm.com/br-pt/think/topics/data-ingestion)
- [Documentação oficial do Airbyte](https://docs.airbyte.com/)
- [Airbyte: ETL e ELT para Engenharia de Dados — DS Academy](https://blog.dsacademy.com.br/airbyte-etl-e-elt-para-engenharia-de-dados/)
- [Extraindo e carregando dados com Airbyte — Medium](https://medium.com/data-hackers/extraindo-e-carregando-dados-de-forma-f%C3%A1cil-com-airbyte-6e29cdc1d008)
- [Explorando o dlt: alternativa Python ao ETL tradicional — Medium](https://medium.com/@samuelviana2626/exploring-dlt-a-python-native-alternative-to-traditional-etl-tools-2a3383700f86)
- [Documentação oficial do dlt](https://dlthub.com/docs/intro)

---

## 🔄 ETL e ELT

**ETL** (extrair, transformar e carregar) ou **ELT** (extrair, carregar e transformar) são termos cotidianos para qualquer profissional da área de dados. Eles representam como o processo será feito nos pipelines. No caso de um ETL, o processo ocorre da seguinte forma: primeiro o dado é extraído da fonte, depois é transformado e só então vai para um Data Warehouse ou outra opção de destino. Você deve estar pensando "o que seria essa transformação?". Pode ser um tratamento de nulos, remoção de duplicatas ou mudança de formatação. No ELT ocorre o contrário: o dado é extraído da fonte e logo é ingerido, para só então ser tratado. O ELT é amplamente aplicado nas plataformas de nuvem, pois aproveita o processamento nativo dos Data Warehouses para transformar os dados, aliado a ferramentas como o **dbt**.

O dbt é uma das principais ferramentas de transformação de dados em Data Warehouses, permitindo o versionamento dos templates criados. Esses templates podem ser utilizados em outros pipelines e facilitam a reutilização de código. Além disso, o dbt se destaca por permitir a criação de testes automáticos de qualidade e a geração da linhagem dos dados (isso será aprofundado quando falarmos de qualidade dos dados), o que ajuda a entender todo o caminho que a informação percorreu e garante que os dados entregues sejam confiáveis.

### 📚 Onde aprender de graça?

- [ETL vs ELT — dbt Blog](https://www.getdbt.com/blog/etl-vs-elt)
- [Documentação oficial do dbt](https://docs.getdbt.com/docs/introduction?version=1.12)
- [ELT vs ETL — IBM](https://www.ibm.com/think/topics/elt-vs-etl)
- [Playlist: Aprendendo dbt — YouTube](https://www.youtube.com/playlist?list=PLc2EZr8W2QIBegSYp4dEIMrfLj_cCJgYA)
...
Um detalhe sobre o Airflow que pode ajudar muito na construção dos seus projetos é o **Astro CLI**, uma ferramenta que auxilia na criação do ambiente onde o Airflow vai rodar (quando você estudar sobre o Airflow, vai ver que são necessários alguns preparativos para que ele funcione perfeitamente). Isso evita erros de ambiente, que geralmente são uma grande dor de cabeça no início, porém, recomendo que ao menos nas primeiras vezes você construa o ambiente manualmente para entender os passos e só após isso vá para o Astro CLI.

### 📚 Onde aprender de graça?

- [Melhor canal para aprender Airflow — YouTube](https://www.youtube.com/watch?v=xUKIL7zsjos)
- [Tutorial oficial do Apache Airflow](https://airflow.apache.org/docs/apache-airflow/stable/tutorial/index.html)
- [Introdução ao Airflow — Astronomer](https://www.astronomer.io/docs/learn/intro-to-airflow)
- [Guia para iniciantes no Apache Airflow — Medium](https://medium.com/@sumitmudliar/beginners-guide-to-apache-airflow-4827c3f4bfe4)
...
- [Docker para iniciantes — YouTube](https://www.youtube.com/watch?v=ntbpIfS44Gw)
- [Docker na prática — YouTube](https://www.youtube.com/watch?v=Y6kz884AoME)
